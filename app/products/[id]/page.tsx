          ...
          <div>
            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                const size = (form.elements.namedItem('size') as HTMLSelectElement)?.value || defaultSize?.size
            ...
            >
              <div>
                <label htmlFor="size" className="block text-sm text-gray-300 mb-1">Size</label>
                <select id="size" name="size" defaultValue={defaultSize?.size} className="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2">
                  {product.sizes.map((s) => (
              ...
              <div>
                <label htmlFor="qty" className="block text-sm text-gray-300 mb-1">Quantity</label>
                <input id="qty" name="qty" type="number" min={1} defaultValue={1} className="w-32 bg-gray-900 border border-gray-700 rounded px-3 py-2" />
              </div>
              <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded py-2">Add to Cart</button>
            </form>

            <div className="mt-6 space-y-2">
              <p className="text-sm text-gray-300">First-time buyers: you’ll need supplies for reconstitution:</p>
              <ul className="text-sm list-disc list-inside">
                ...
                <li>
                  BAC water: <a className="text-blue-400 hover:underline" target="_blank" href="https://www.amazon.com/s?k=bac+water+for+peptides&crid=1BU0WL466H73K&sprefix=bac+wa%2Caps%2C128&ref=nb_sb_ss_p13n-expert-pd-ops-ranker_2_6" rel="noreferrer">Amazon BAC water search</a>
                </li>
              </ul>
            </div>

            <div className="mt-6 flex gap-3">
              <Link href="/#research" className="bg-gray-700 hover:bg-gray-600 rounded px-4 py-2">More Information</Link>
              <Link href="/#products" className="bg-gray-700 hover:bg-gray-600 rounded px-4 py-2">Browse More Products</Link>
            </div>
          </div>
        </div>
      </div>
